jQuery(document).ready(function() {
	...
	images = [
		...
		{
			'url': 'data/AT_mean_T1ToD_NORSRS_0025_cluster_neg.nii.gz',
			'name': 'Neg',
			'colorPalette': 'intense blue',
			'cache': false,
			'intent': 'Intensity:'
		},
        {
			'url': 'data/AT_mean_T1ToD_NORSRS_0025_cluster_pos.nii.gz',
			'name': 'Pos AT cluters in RNAseq Sample',
			'colorPalette': 'intense red',
			'cache': false,
			'intent': 'z-value:'
		}
	]
